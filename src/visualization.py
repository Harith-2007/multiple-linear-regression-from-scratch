...
def plot_cost_comparison(raw_cost_his,norm_cost_his,save=False):
    ...
    ax.plot(raw_iterations,raw_cost_his,label=f"raw_cost, iterations: {len(raw_cost_his)}")
    ax.plot(norm_iterations,norm_cost_his,label=f"normalized_cost, iterations: {len(norm_cost_his)}")
