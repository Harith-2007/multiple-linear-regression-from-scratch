...
from visualization import plot_cost_comparison,actual_data,pred_vs_actual
...
print("\nRaw data model weights:", w_raw)
print("Raw data model bias:", b_raw)
...
print("\nNormalised data model weights:", w_norm)
print("Normalised data bias:", b_norm)
...
print("-" * 60)
print(f"{'Actual GDP (billion $)':>15} {'Predicted GDP (billion $)':>18} {'Error':>15}")
...
pred_vs_actual(y_test, y_test_prediction, save=True)
